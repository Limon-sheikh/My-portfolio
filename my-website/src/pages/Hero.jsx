      ...
      <section id="hero" className="min-h-[calc(100vh-80px)] md:flex md:items-center bg-sec_one_bg_c">
        <div className="container mx-auto">
          <div id="wraper" className="px-5 md:px-0 md:grid md:grid-cols-12 lg:gap-2">
            <div className="pt-[2vh] sm:pt-[3vh] md:pt-0 flex flex-col md:col-span-6">
              <div className="">
                ...
                <div className="mt-[9vh] flex items-center flex-wrap gap-1 py-1">
                  <span className="text-sm text-primary/60 font-medium">{title}</span>
              ...
              <div className="mt-[14vh] lg:mt-[10vh] flex flex-col gap-[4vh] lg:pb-14">
                ...
                <div className="flex justify-between gap-4 md:justify-start md:gap-9">
                  <Button title="view more" border={false} className="bg-accent px-7 py-2 font-semibold text-[4vw] 
                    sm:text-[3vw] md:text-lg hover:bg-hover transition-all duration-300 ease-linear rounded-md text-text_C_W"
                  />
                  <Button title="Downlod Cv" border={true} className="border-accent text-primary px-7 py-2 font-semibold text-[4vw] 
                    sm:text-[3vw] md:text-lg hover:bg-accent transition-all duration-300 ease-linear border-2 rounded-md"
                  />
                </div>
              </div>
            </div>
