        ...
        <div id="wraper" className="px-5 md:px-0 md:grid md:grid-cols-12     md:bg-green-500 ">
          <div className="pt-10 flex flex-col md:col-span-6      md:bg-yellow-300 ">
            <div className="md:bg-yellow-600 ">
              ...
              {/* typewriter */}
              <div className="mt-10 flex items-center flex-wrap gap-1 py-1      md:bg-red-300">
              ...
              <div className=" py-2 min-h-28 md:min-h-0 md:bg-slate-400">
            ...
            <div className="mt-[11vh] md:bg-yellow-900 ">
              ...
              <div className="flex justify-between gap-4 md:justify-start md:gap-16 py-8  md:bg-orange-800">
