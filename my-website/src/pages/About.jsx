  ...
  return (
    <section id="about" className="md:bg-red-400 ">
      <div className="container mx-auto px-5 py-20">
        <div id="wraper" className="rounded-xl overflow-hidden shadow-[0px_0px_15px_7px_rgba(0,_0,_0,_0.1)] md:flex md:bg-green-200">
          <div className="flex flex-col items-center justify-center md:w-[50%]  md:bg-fuchsia-500">
            <div className=" flex justify-center items-center md:rounded-[50%]    md:bg-green-800 ">
              <img src={aboutInfo.image} alt="about image" className="px-5 md:px-0" />
            </div>
          </div>

          <div className="px-5 pt-14 col-span-6 pb-10 md:w-[50%] md:bg-red-700">
