...
export const HeroData = [
  {
    ...
    // Social icons
    socials: [
      {name: "Github", icon: FaGithub, link: "https://github.com/Limon-sheikh", color: "#24292e"},
      {name: "Linkedin", icon: FaLinkedin, link: "https://www.linkedin.com/in/limonsheikh/", color: "#0072B1"},
      {name: "twitter", icon: FaTwitter, link: "#", color: "#1DA1F2"},
      {name: "instagram", icon: FaInstagram, link: "#", color: "#d62976"},
      {name: "Facebook", icon: FaFacebook, link: "https://www.facebook.com/limonsheikh23", color: "#1877F2"},
      {name: "youtube", icon: FaYoutube, link: "https://www.youtube.com/@webroots", color: "#FF0000"},
    ],
  },
];
